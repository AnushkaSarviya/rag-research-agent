...
class RequestState(BaseModel):
    ...
    allow_search: bool = False   # kept for compatibility, ignored in RAG
...
app = FastAPI(title="LangGraph Research & Summarization Agent",
...
def chat_endpoint(request: RequestState): 
    ...
    if request.retrieved_chunks:
        ...
        # Otherwise fall back to plain chatbot
